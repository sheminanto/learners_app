...
var english = [
  ...
  Question(
    ...
    "Take all reasonable steps to secure medical attention to the injured and report to the nearestpolicestation within 24 hours"
  ]),
  Question("On a road designated as one way", 2, [
    "Parking is prohibited",
    "Overtaking is prohibited",
    "Should not drive in reverse gear"
  ]),
  Question("You can overtake a vehicle in front", 0, [
  ...
  Question("Driver of a vehicle may overtake", 2, [
  ...
  Question("Driver of a motor vehicle shall drive through", 1, [
    "The right side of the road",
    "The left side of the road",
    "The Center of the road"
  ]),
  Question("When a Vehicle is parked on the road side during night", 2, [
  ...
  Question("Fog lamps are used", 1, [
    "During night",
    "When there is mist",
    "When the opposite vehicle is not using dim light"
  ]),
  Question("Zebra lines are meant for..", 1, [
    "stopping vehicle",
    "pedestrians crossing",
    "for giving preference to vehicle"
  ]),
  Question("When an ambulance is approaching ..", 2, [
  ...
  Question("Red traffic light indicates ..", 1,
      ["vehicle can proceed with caution", "stop the vehicle", "slow down"]),
  Question("Parking a vehicle in front of entrance to hospital", 1,
      ["Proper", "Improper", "Proper if NO PARKING sign is not provided"]),
  Question(
      "When the slippery road sign is seen on the road, the driver shall", 0, [
    "reduce the speed by changing the gear",
    "apply brake",
    "proceed in the same speed"
  ]),
  Question("Overtaking is prohibited in following circumstances", 0, [
    "when it is likely to cause inconvenience or danger to other traffic",
    "when the vehicle in front is reducing speed",
    "during night"
  ]),
  Question("Overtaking when approaching a bend", 1,
      ["is permissible", "not permissible", "is permissible with care"]),
  Question("Drunken driving", 2, [
    "allowed in private vehicles",
    "allowed during night time",
    "prohibited in all vehicles"
  ]),
  Question("Use of horn prohibited", 1, [
    "Mosque, Church and Temple",
    "Near Hospital, Courts of Law",
    "Near Police Station"
  ]),
  Question("Rear view mirror is used", 1, [
    "for seeing face",
    "for watching the traffic approaching from behind",
    "for seeing the back seat passenger"
  ]),
  Question("Boarding in and alighting from a vehicle while in motion", 2, [
    "Permitted in bus",
    "permitted in autorikshaw",
    "prohibited in all vehicles"
  ]),
  Question("Parking is permitted", 2,
      ["In turnings", "On foot paths", "Where parking is not prohibited"]),
  Question("When fuel is filled in a vehicle", 1, [
    "shall not check air pressure",
    "shall not smoke",
    "shall not use any light of the vehicle"
  ]),
  Question("Mobile phones shall not be used", 2, [
    "in Government offices",
    "in Police Stations",
    "While driving a vehicle"
  ]),
  Question("Overtaking is prohibited", 0, [
  ...
  Question("Records of a private vehicle are", 1, [
  ...
  Question(
      ...
      2,
      ["18 years", "21 years", "16 years"]),
  Question("When you see the traffic sign School, you should", 1, [
    "Stop the vehicle, sound horn and proceed",
    "Slow down and proceed with caution",
    "Sound horn continuously and proceed"
  ]),
  Question("While turning to the left, the driver of a two wheeler shall", 2, [
    "Extend his left hand towards left",
    "Not show hand signal",
    "Show left turn signal with his right hand"
  ]),
  Question("The Signal while taking U-turn", 1,
      ["Left turn signal", "Right turn signal", "Slow down signal"]),
  Question("The driver of a vehicle shall not take U-turn", 1, [
    "In a road where there is no traffic restrictions",
    "In a busy road",
    "When there are vehicles passing through the left"
  ]),
  Question("One time tax for a new car is for", 1, [
    "Till the registration of the vehicle is cancelled",
    "15 years",
    "5 years"
  ]),
  Question("Before overtaking a vehicle, it should be ensured that", 1, [
  ...
  Question(
      "Number of persons can be carried in the cabin of a Goods Carriage", 2, [
    "5 Persons",
    "Sufficient persons for loading and unloading the goods",
    "As many persons as recorded in the Registration Certificate"
  ]),
  Question("When your vehicle is being overtaken, you should", 2, [
  ...
  Question("A place where parking is prohibited", 2,
      ["In front of a parked vehicle", "On one-way road", "On foot-path"]),
  Question("The hand brake is to be used", 2,
      ["To reduce the speed", "To apply sudden brake", "To park a vehicle"]),
  Question("More than two persons on a two wheeler is", 1, [
    "Allowed in unavoidable circumstances",
    "Violation of law",
    "Allowed when the traffic is less"
  ]),
  Question("You want to overtake a vehicle near a hospital.You will", 1, [
    "Blow the horn continuously",
    "Not blow horn",
    "Blow the horn only intermittently"
  ]),
  Question("Using unregistered vehicle in public place is", 0,
      ["Illegal", "Legal", "Legal if there is urgency"]),
  Question("Minimum age for obtaining driving licence for transport vehicles",
      2, ["25 years", "18 years", "20 years"]),
  Question("Overtaking is prohibited in the following case", 2,
      ["State highway", "Panchayath roads", "Narrow bridge"]),
  Question(
  ...
  Question("Parking prohibited in the following case ..", 2,
      ["road side", "where parking is permitted", "near traffic light"]),
  Question("Over speeding", 0, [
  ...
  Question("When a blind person crosses the road holding White Cane", 0, [
    "The driver of a vehicle shall consider the white cane as a traffic sign to stop the vehicle",
    "Blow the horn and proceed",
    "Slow down and proceed with caution"
  ]),
  Question("When a motor vehicle is involved in an accident", 0, [
  ...
  Question(
      "When any property of a third party is damaged due to an accident", 0, [
  ...
  Question("When the vehicle behind has begun to over take our vehicle", 0, [
  ...
  Question("When our vehicle is being over taken", 0, [
    "We shall not increase speed",
    "We can increase speed",
    "We can increase speed with due care"
  ]),
  Question("Parking is prohibited in the following place", 0,
      ["Entrance of hospital", "Left side of the road", "Market area"]),
  Question("Parking is prohibited in the following place", 0, [
    "blocking a fire hydrant",
    "near a public well",
    "left side of the road"
  ]),
  Question("To carry pillion rider on a motor cycle", 0, [
  ...
  Question("Carrying overload in goods carriages", 2, [
  ...
  Question("While you are driving on gradient roads, you should", 1, [
  ...
  Question("The driver of a tractor shall not carry", 0, [
  ...
  Question("You can overtake a vehicle through the left side if", 0, [
  ...
  Question("What is 'Tail-gating' ?", 0, [
  ...
  Question("A vehicle can be seized by authorised officers, if", 0, [
  ...
  Question("Type of horn permitted", 2,
      ["Air- horn", "Multi-toned horn", "Electric horn"]),
  Question("Road on which driving in reverse gear is prohibited", 0,
      ["One-way road", "Steep descending road", "Steep ascending road"]),
  Question(
  ...
  Question("You hold a learners licence for motor cycle", 2, [
  ...
  Question("All motor vehicles must be covered by", 1,
      ["Life Insurance", "Third party Insurance", "Comprehensive Insurance"]),
  Question("Minimum distance to be kept from the vehicle going in front", 2,
      ["10 meter", "5 meter", "safe distance according to speed"]),
  Question(
  ...
  Question("Overtaking is prohibited when ..", 2, [
  ...
  Question("If the road is marked with broken white lines", 1, [
    "shall not change track",
    "can change track if required",
    "shall stop the vehicle"
  ]),
  Question("Blinking red traffic light means", 1, [
  ...
  Question(
      ...
      1,
      ["60 km/hour", "70 km/hour", "80 km/hour"]),
  Question("What is defensive driving ?", 0, [
  ...
  Question("What is meant by stop line", 0, [
  ...
  Question("Before starting the engine of a vehicle", 0, [
    "Check radiator water level and engine oil level",
    "Check head light",
    "Check brake"
  ]),
  Question("Maximum permissible speed of a motor cycle", 1,
      ["No Limit", "50 Km/hr", "60 Km/hr"]),
  Question(
  ...
  Question(
      ...
      1,
      ["150 cm", "100 cm", "120 cm"]),
  Question("Maximum permissible speed of heavy motor vehicles in the cities", 1,
      ["35 Km/hr", "45 Km/hr", "60 Km/hr"]),
  Question("Maximum distance allowed between towing and towed vehicles", 1,
      ["15 meters ", "5 meters", "10 meters"]),
  Question("Maximum permissible speed of a motor cycle in cities", 0,
      ["40 km/hour", "30 km/hour", "50 km/hour"]),
  Question(
  ...
  Question("Maximum speed permitted for vehicles towing another vehicle", 1,
      ["20 km/hour", "24 km/hour", "32 km/hour"]),
  Question(
      "Motor vehicle which is not permitted to drive in ghat roads at a speed of more than 30 Km/h",
      1,
      ["heavy passenger vehicle", "motor car", "Autorickshaw"]),
  Question(
  ...
  Question(
      ...
      1,
      ["25Km/hr", "30 Km/hr", "40 Km/hr"]),
  Question("Maximum permitted weight that can be carried on a goods carriage",
      1, ["No limit", "allowed as per permit", "10 ton"]),
  Question("The minimum fine for over - loading in goods carriage", 1,
      ["Rs- 1000/-", "Rs- 2000/-", "Rs- 3000/-"]),
  Question(
      "Maximum permissible speed of an autorickshaw near educational inistitution",
      1,
      ["35 km/hour", "25 km/hour", "20 km/hour"]),
  Question(
      "Maximum permissible speed of a light motor vehicle near educational institution",
      2,
      ["45 km/hour", "35 km/hour", "25 km/hour"]),
  Question("Maximum permissible speed of motor car on ghat roads", 0,
      ["40 km/hour", "30 km/hour", "20 km/hour"]),
  Question("Maximum permissible speed of motor cycle on ghat roads", 2,
      ["30 km/hour", "35 km/hour", "40 km/hour"]),
  Question("Maximum permissible speed of an autorickshaw", 2,
      ["50 Km/hr", "30 Km/hr", "40 Km/hr"]),
  Question("Maximum permissible speed of a light motor vehicle", 0,
      ["60 Km/hr", "70 Km/hr", "No limit"]),
  Question("Maximum permissible speed of a medium motorvehicle", 1,
      ["80 Km/hr", "65 Km/hr", "70 Km/hr"]),
  Question("According to section 112 of the Motor Vehicles Act 1988", 0, [
  ...
  Question("Maximum speed allowed to vehicles passing a procession", 1,
      ["15 KM/hr", "25 KM/hr", "35 KM/hr"]),
  Question("The height limit of load on goods vehicle from ground level", 0,
      ["3.8 meters", "3 meters", "no limit"]),
  Question(
      "Maximum permissible speed of heavy motor vehicle near education inistitution",
      2,
      ["35 km/hour", "25 km/hour", "15 km/hour"]),
  Question(
  ...
  Question(
      ...
      0,
      ["15 km/hour", "25 km/hour", "35 km/hour"]),
  Question("Maximum permissible speed of autorickshaws on ghat road", 0,
      ["30 km/hour", "40 km/hour", "20 km/hour"]),
  Question("Maximum permissible speed of heavy motor vehicles on ghat roads", 0,
      ["35 km/hour", "25 km/hour", "15 km/hour"]),
  Question(
      "Maximum permissible speed of autorikshaw in cites and municipal towns",
      1,
      ["40 Km/hr", "30 Km/hr", "20 Km/hr"]),
  Question("Maximum permissible speed of heavy motor vehicles", 1,
      ["70 Km/hr", "65 Km/hr", "50 Km/hr"]),
  Question("Maximum permissible speed of medium motor vehicles on ghat roads",
      1, ["45 km/hour", "35 km/hour", "25 km/hour"]),
  Question(
  ...
  Question("The following sign represents..", 0,
      ["Stop", "No parking ", "Hospital ahead"],
      img: "r1.png"),
  Question("The following sign represents.. ", 2,
      ["Keep left ", "There is no road to the left ", "Compulsory turn left"],
      img: "r2.png"),
  Question("The following sign represents.. ", 0,
      ["Give way", "Hospital ahead", "Traffic island ahead "],
      img: "r3.png"),
  Question("The following sign represents..", 1,
  ...
  Question(
      ...
      img: "r10.png"),
  Question("The following sign represents.. ", 2,
      ["First aid post", "Resting place", "Hospital"],
      img: "r11.png"),
  Question("The following sign represents.. ", 0,
      ["First aid post", "Resting place", "Hospital"],
      img: "r12.png"),
  Question("The following sign represents.. ", 1,
      ["Hospital", "Resting place", "First aid post"],
      img: "r13.png"),
  Question("The following sign represents.. ", 2,
  ...
  Question(
      ...
      img: "r17.png"),
  Question("The following sign represents.. ", 0,
      ["Cross road", "No entry", "Hospital"],
      img: "r18.png"),
  Question("The following sign represents.. ", 1,
      ["Restriction ends", "No entry", "No overtaking"],
      img: "r19.png"),
  Question(
      "The following sign represents.. ",
      2,
      ...
      img: "r20.png"),
  Question("The following sign represents.. ", 0,
      ["Sound horn compulsory", "Sound horn continuously", "Horn prohibited"],
      img: "r21.png"),
  Question(
      "The following sign represents.. ",
      1,
      ...
      img: "r22.png"),
  Question("The following sign represents.. ", 2,
      ["End of restriction", "Do not stop", "No parking"],
      img: "r23.png"),
  Question("The following sign represents.. ", 1,
      ["Go straight", "One-way", "Prohibited in both direction"],
      img: "r24.png"),
  Question(
      "The following sign represents.. ",
      0,
  ...
  Question(
      ...
      img: "r32.png"),
  Question("The following sign represents.. ", 1,
      ["Stop", "No Stopping or standing", "Junction"],
      img: "r33.png"),
  Question("The following sign represents.. ", 1,
      ["No entry", "Ahead only", "Entry in both direction"],
      img: "r34.png"),
  Question(
      "The following sign represents.. ",
      1,
      ...
      img: "r35.png"),
  Question("The following sign represents.. ", 1,
      ["Stop on the left side", "Compulsory keep left", "Turn left"],
      img: "r36.png"),
  Question("The following sign represents.. ", 1,
      ["Right ascend", "Right hand curve", "Keep right"],
      img: "r37.png"),
  Question("The following sign represents.. ", 0,
      ["Left hand curve", "Left ascend", "Keep left"],
      img: "r38.png"),
  Question("The following sign represents.. ", 0,
      ["Right hair pin bend", "Right ascend and descend", "Right descend"],
      img: "r39.png"),
  Question("The following sign represents.. ", 1,
      ["Left descend", "Left hair pin bend", "Keep left"],
      img: "r40.png"),
  Question("The following sign represents.. ", 0,
      ["Right reverse bend", "Left reverse bend", "Turn right and go ahead"],
      img: "r41.png"),
  Question("The following sign represents.. ", 1,
      ["Right reverse bend", "Left reverse bend", "Turn left and go ahead"],
      img: "r42.png"),
  Question("The following sign represents.. ", 2,
      ["Side road left", "Speed limit", "Axle weight limit"],
      img: "r43.png"),
  Question("The following sign represents.. ", 1,
      ["Turn right", "Side road right", "Keep right"],
      img: "r44.png"),
  Question("The following sign represents.. ", 0,
      ["Major Road ahead", "Cross Road ahead", "Narrow road ahead"],
      img: "r45.png"),
  Question("The following sign represents.. ", 2,
      ["Turn right", "Turn left", "Round about"],
      img: "r46.png"),
  Question("The following sign represents.. ", 1,
      ["Narrow road ahead", "Dangerous dip", "Ferry"],
      img: "r47.png"),
  Question("The following sign represents.. ", 0,
      ["Guarded level cross", "Unguarded level cross", "Barrier ahead"],
      img: "r48.png"),
  Question("The following sign represents.. ", 0,
      ["Y-inter section left", "Y-inter section right", "Side road left"],
      img: "r49.png"),
  Question("The following sign represents.. ", 1,
      ["Y-inter section left", "Y-inter section right", "Side road right"],
      img: "r50.png"),
  Question("The following sign represents.. ", 2,
      ["Turn left", "Turn right", "Y-inter section"],
      img: "r51.png"),
  Question(
      "The following sign represents.. ",
      2,
      ...
      img: "r52.png"),
  Question("The following sign represents.. ", 0,
      ["Slippery road", "Gravel road", "No entry for motor car"],
      img: "r53.png"),
  Question("The following sign represents.. ", 0,
      ["Loose gravel", "Slippery road", "No entry for motor car"],
      img: "r54.png"),
  Question("The following sign represents.. ", 0,
      ["Cycle crossing", "Cycle crossing prohibited", "No entry for cycles"],
      img: "r55.png"),
  Question(
      "The following sign represents.. ",
      1,
  ...
  Question(
      ...
      img: "r57.png"),
  Question("The following sign represents.. ", 0,
      ["Men at work", "Children playing", "Pedestrian crossing"],
      img: "r58.png"),
  Question("The following sign represents.. ", 2,
      ["Rough road", "Slippery road", "Falling rocks"],
      img: "r59.png"),
  Question("The following sign represents.. ", 1,
      ["Bridge ahead", "Ferry", "Refreshment stall ahead"],
      img: "r60.png"),
  Question("The following sign represents.. ", 0,
      ["Steep ascend", "Steep descend", "Slippery road"],
      img: "r61.png"),
  Question("The following sign represents.. ", 1,
      ["Steep ascend", "Steep descend", "Slippery road"],
      img: "r62.png"),
  Question("The following sign represents.. ", 2,
      ["Narrow road ahead", "Y-intersection", "Road widens ahead"],
      img: "r63.png"),
  Question("The following sign represents.. ", 2,
      ["Drainage in middle", "Bridge ahead", "Gap in median"],
      img: "r64.png"),
  Question("The following sign represents.. ", 0,
      ["Hump or rough road", "Zigzag road", "Ghat road"],
      img: "r65.png"),
  Question("The following sign represents.. ", 0,
      ["Barrier ahead", "Railway cross ahead", "Weighbridge ahead"],
      img: "r66.png"),
  Question("The following sign represents.. ", 0,
      ["No thorough side road", "Left turn", "Bridge ahead"],
      img: "r67.png"),
  Question("The following sign represents.. ", 2,
      ["Ferry ahead", "Main road ahead", "No thorough road"],
      img: "r68.png"),
  Question("The following sign represents.. ", 1,
      ["Parking prohibited", "Parking both sides", "Police aid post"],
      img: "r69.png"),
  Question(
      "The following sign represents.. ",
      0,
  ...
  Question(
      ...
      [
        ...
        "Request to stop the vehicle from behind andfront"
      ],
      img: "r78.png"),
  Question(
      "The following sign represents.. ",
