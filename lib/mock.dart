...
class _MockState extends State<Mock> {
  ...
  int _totalScore = 0;
  int ans;
  final Duration _duration = const Duration(minutes: 20);
  var _index = 0;
...
//          q = random.nextInt(english.length);
  ...
  Widget build(BuildContext context) {
    ...
    _generateQuestion();
    return _index < 20 ? Container(
      child: english[_questionIndex[_index]].img == null ? Column(
        children: <Widget>[
          ListTile(
            title: Text((_index + 1).toString()+"." + english[_questionIndex[_index]].qstn,
      ...
      Column(
        children: <Widget>[
          ...
          Image.asset('assets/images/'+english[_questionIndex[_index]].img),
          RadioListTile(
            title: Text(english[_questionIndex[_index]].option[0]),
            value: 1,
            groupValue: selectedOption,
